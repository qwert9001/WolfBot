...
//	{ "camera", CG_Camera_f },	// duffy
	...
	// Waypoints
	{ "wp_load", Cmd_WP_LoadFile },						// DONE
	{ "wp_save", Cmd_WP_SaveFile },						// DONE
	{ "wp_place", Cmd_WP_PlaceWaypoint },				// DONE
	{ "wp_objective", Cmd_WP_PlaceObjective },			// DONE
	{ "wp_delete", Cmd_WP_DeleteWaypoint },				// DONE
	{ "wp_setflags", Cmd_WP_SetFlags },					// DONE
	{ "wp_connect", Cmd_WP_ConnectWaypoints },			// DONE
	{ "wp_disconnect", Cmd_WP_DisconnectWaypoints },	// DONE
	{ "wp_setpathflags", Cmd_WP_SetPathFlags },			// DONE
	{ "wp_rendermode", Cmd_WP_Rendermode },				// DONE
	{ "wp_cleanup", Cmd_WP_Cleanup },					// DONE
	{ "wp_testpath", Cmd_WP_TestPath },					// DONE
	{ "wp_dumpflags", Cmd_WP_DumpFlags },				// DONE
	{ "wp_pathbox", Cmd_WP_PathBox },					// DONE
	{ "wp_menu", Cmd_WP_Menu },							// DONE

	{ "bot_menu", Cmd_Bot_Menu }
