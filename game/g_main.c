...
vmCvar_t	g_svBotFlag;
vmCvar_t	wb_autoEngineer;
vmCvar_t	wb_allowSuicide;
vmCvar_t	wb_allowRadio;
vmCvar_t	wb_allowMG42;
vmCvar_t	wb_minPlayers;
vmCvar_t	wb_chatFile;
...
// jpw
	...
	{ &g_svBotFlag, "g_svbotflag", "1", CVAR_ROM, 0, qfalse },
	{ &wb_autoEngineer, "wb_autoengineer", "1", CVAR_ARCHIVE, qfalse },
	{ &wb_allowSuicide, "wb_allowsuicide", "0", CVAR_ARCHIVE, qfalse },
	{ &wb_allowRadio, "wb_allowradio", "1", CVAR_ARCHIVE, qfalse },
	{ &wb_allowMG42, "wb_allowmg42", "1", CVAR_ARCHIVE, qfalse },
	{ &wb_minPlayers, "wb_minPlayers", "0", CVAR_ARCHIVE, qfalse },
	{ &wb_chatFile, "wb_chatfile", "botchat.cfg", CVAR_ARCHIVE|CVAR_LATCH, qfalse },
...
#pragma export off
	...
	case GAME_CLIENT_CONNECT:
		// # BOT CODE # : This is beeing sent for every connected client on map_restarts.
		// If the Client is some sort of fake bot arg2 will be TRUE
		if( arg2 )
		{
			Svcmd_Bot_Connect( NULL, TRUE, arg0 );
			return 0;
		}
	...
	case GAME_CLIENT_BEGIN:
		// # BOT CODE # : This is beeing sent for every connected client on map_restarts.
		// Bots don't need to call ClientBegin here as they already should have done it.
		if( g_entities[ arg0 ].botClient )
			return 0;
