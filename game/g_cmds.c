...
//		Cmd_SetCameraOrigin_f( ent );
	...
	// # BOT CODE #
	else if (Q_stricmp (cmd, "bot_moveto") == 0)
		Cmd_Bot_MoveTo(ent);
	else if (Q_stricmp (cmd, "bot_changeyaw") == 0)
		Cmd_Bot_ChangeYaw(ent);
	else if (Q_stricmp (cmd, "bot_changepitch") == 0)
		Cmd_Bot_ChangePitch(ent);
	else if (Q_stricmp (cmd, "bot_follow") == 0)
		Cmd_Bot_Follow(ent);
	else if (Q_stricmp (cmd, "bot_killself") == 0)
		Cmd_Bot_Debug_GoWounded(ent);
	else if (Q_stricmp (cmd, "bot_dumpwordlists") == 0)
		Bot_DumpWordLists();
